        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {products.map((product) => (
            ...
            >
              ...
              <p className="text-sm text-steel dark:text-gray-400 leading-relaxed mb-4 flex-1">
                {product.description}
              </p>

              <dl className="text-xs font-mono space-y-1.5 border-t border-black/5 dark:border-white/10 pt-4">
